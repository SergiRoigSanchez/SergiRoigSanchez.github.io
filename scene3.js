class Scene3 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.audio('song3', 'assets/sfx/the-last-trial.mp3');
  }
  ...
  create() {
    ...
    var tileset = map3.addTilesetImage('platformPack_tilesheet', 'tiles');
    var platforms = map3.createStaticLayer('Platforms', tileset, 0, 0);
    platforms.setCollisionByExclusion(-1, true);

    this.physics.world.setBounds( 0, 0, 3584, 1792 );

    this.player = this.physics.add.sprite(3524, 800, 'player');
    ...
    this.song3 = this.sound.add('song3', {volume: 0.10});
    this.song3.play()
    ...
    var spikeObjects = map3.getObjectLayer('Spikes')['objects'];
    ...
    var spike2Objects = map3.getObjectLayer('Spikes2')['objects'];
    ...
    var lavaObjects = map3.getObjectLayer('Lava')['objects'];
    ...
    var stairObjects = map3.getObjectLayer('Stairs')['objects'];
    stairObjects.forEach(stairObject => {
      var stair = this.stairs.create(stairObject.x, stairObject.y - stairObject.height, 'stair').setOrigin(0, 0);
    });
    this.physics.add.overlap(this.player, this.stairs, this.stairHit, null, this);
    ...
    var water1Objects = map3.getObjectLayer('Water1')['objects'];
    ...
    var water2Objects = map3.getObjectLayer('Water2')['objects'];
    ...
    var doorObjects = map3.getObjectLayer('Doors')['objects'];
    ...
    var keyObjects = map3.getObjectLayer('Keys')['objects'];
