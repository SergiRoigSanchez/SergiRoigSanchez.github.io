class Scene1 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.audio('song1', 'assets/sfx/last-son-of-Timbur.mp3');
  }
  ...
  create() {
    ...
    this.player = this.physics.add.sprite(50, 1250, 'player');
    ...
    this.song1 = this.sound.add('song1', {volume: 0.10});
    this.song1.play()
    ...
    var spike2Objects = map.getObjectLayer('Spikes2')['objects'];
    ...
    var blue_blockObjects = map.getObjectLayer('BlueBlocks')['objects'];
    ...
    var diamondObjects = map.getObjectLayer('Diamonds')['objects'];
    ...
    var stairObjects = map.getObjectLayer('Stairs')['objects'];
    ...
    var doorObjects = map.getObjectLayer('Doors')['objects'];
    ...
    var keyObjects = map.getObjectLayer('Keys')['objects'];
  ...
  blueBlockHit (player, blue_block)
  {
    if (this.score < 8){
      ...
      this.infoText.setText(this.info);
      // this.time.addEvent(5000, this.infoText.setText(''), this.infoText);
    }
  }
